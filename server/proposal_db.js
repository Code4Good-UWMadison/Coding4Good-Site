...
exports.createProposal = async (proposal) => {
    ...
    try {
      ...
      await client.query(query, [proposal.org_name, proposal.org_type, proposal.org_detail, proposal.name, proposal.position, proposal.email, proposal.contact, proposal.title, proposal.description]);
